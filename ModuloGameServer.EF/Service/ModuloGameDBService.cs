...
namespace ModuloGameServer.Contracts
{
    public class ModuloGameDBService : IModuloGameDBService
    {
        ...
        private IDataSourceUserConfirmation myDataSourceUserConfirmation = null;
        public IDataSourceUserConfirmation DataSourceUserConfirmation
        {
            get
            {
                return (myDataSourceUserConfirmation == null) ? (myDataSourceUserConfirmation = new DataSourceUserConfirmation(context)) : myDataSourceUserConfirmation;
            }
        }
